UE.registerUI('kityformula', function(editor, uiname){
    ...
    var kfDialog = new UE.ui.Dialog({
        ...
        // 指定弹出层路径
        iframeUrl: editor.options.UEDITOR_HOME_URL + 'plugins/kityformula-plugin/kityFormulaDialog.html',
        // 编辑器实例
        editor: editor,
        // dialog 名称
        name: 'dialog-' + uiname,
    ...
    editor.ready(function(){
        ...
        editor.addListener("contentChange", function(e){
            //window.MathJax.Hub.Queue(["Typeset", MathJax.Hub, editor.document]);
        }); 
    });

    var iconUrl = editor.options.UEDITOR_HOME_URL + 'plugins/kityformula-plugin/kf-icon.png';
